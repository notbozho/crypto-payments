...
export default function BackupCodesStep() {
    ...
    const handleContinue = () => {
        goToNextStep(); // Advance to completion
    };
        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-50">
            <Card className="w-full max-w-md">
                <CardHeader className="text-center">
                    ...
                    <CardDescription>
                        These codes will help you access your account if you
                        lose your device
                    </CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                    <Alert>
                        ...
                        <AlertDescription>
                            <strong>Critical:</strong> These backup codes are
                            your only way to access your account if you lose
                            your authenticator device. Save them in a secure
                            location now!
                        </AlertDescription>
                    </Alert>
                        ...
                        {savedBackupCodes && (
                            <Alert className="border-green-200 bg-green-50">
                                ...
                                <AlertDescription className="text-green-800">
                                    Great! You&apos;ve downloaded your backup
                                    codes. Keep them safe!
                                </AlertDescription>
                            </Alert>
                        )}
                        ...
                        <div className="space-y-3">
                            ...
                            {!savedBackupCodes && (
                                <p className="text-xs text-center text-gray-500">
                                    You must download or copy your backup codes
                                    to continue
                                </p>
                            )}
                        </div>
