            ...
            <Card className="w-full max-w-md">
                ...
                <CardContent className="space-y-6">
                                ...
                                {!walletData && (
                                    <div className="p-3 bg-yellow-50 rounded-lg border border-yellow-200">
                                        <p className="text-xs text-yellow-800">
                                            ...
                                            You can add a wallet anytime in your
                                            settings for easier withdrawals.
                                        </p>
                                    </div>
                                )}
                                {skipped2FA && (
                                    <div className="p-3 bg-orange-50 rounded-lg border border-orange-200">
                                        <p className="text-xs text-orange-800">
                                            <strong>Enable 2FA later:</strong>{" "}
                                ...
                                {has2FA && (
                                    <div className="p-3 bg-green-50 rounded-lg border border-green-200">
                                        <p className="text-xs text-green-800">
                                            ...
                                            Store them securely - they&apos;re
                                            your only backup if you lose your
                                            authenticator.
                                        </p>
                                    </div>
                                )}
                    ...
                    <p className="text-xs text-center text-gray-500">
                        Welcome to CryptoPay! Let&apos;s start building your
                        payment business.
                    </p>
                </CardContent>
            </Card>
